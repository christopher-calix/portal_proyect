...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:spei="http://www.sat.gob.mx/spei" xmlns:nomina="http://www.sat.gob.mx/nomina" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:aieps="http://www.sat.gob.mx/acreditamiento" xmlns:ecc11="http://www.sat.gob.mx/EstadoDeCuentaCombustible" xmlns:cce="http://www.sat.gob.mx/ComercioExterior" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:pago10="http://www.sat.gob.mx/Pagos" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11">
  ...
  <!--
	...
	-->
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/utilerias.xslt"/>
  <!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/ecc.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/donat11.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/divisas.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/detallista.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/implocal.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/terceros11.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/iedu.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/ventavehiculos11.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/pfic.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/leyendasFisc.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/spei.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/nomina12.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/cfdiregistrofiscal.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/pagoenespecie.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/consumodecombustibles.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/valesdedespensa.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/aerolineas.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/notariospublicos.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/vehiculousado.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/servicioparcialconstruccion.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/certificadodedestruccion.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/obrasarteantiguedades.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/AcreditamientoIEPS10.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/ecc11.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/ComercioExterior10.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/ine11.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/nomina12.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/Pagos10.xslt"/>
  <xsl:include href="{{XSLT_COMPLEMENTS_PATH}}/ComercioExterior11.xslt"/>
